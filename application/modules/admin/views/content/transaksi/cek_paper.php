					            ...
					            <tr>
												...
												<td><?php echo $v_paper['status'] ?></td>
													<td>
														<ul class="demo-btns">
															<li>
																<a href="<?php echo base_url() . 'admin/edit/transaksi/cek_paper/' . $v_paper['id_paper'] ?>" data-toggle="modal" data-target="#lihatberkas">
																	<button type="button" name="byredit" class="btn btn-warning"><i class="fa  fa-search"></i></button>
																</a>
															</li>
														</ul>
													</td>
