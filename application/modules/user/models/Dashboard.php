        ...
        if ($r2->num_rows() == 1 && $r3->num_rows() == 1) {
          ...
          if ($cdate > $deadline) {
            ...
            if ($rqty == '0') {
              ...
              $this->form_validation->set_rules('idevent','EID','required');
              $this->form_validation->set_rules('jenreg','Jen Reg','required');
              $this->form_validation->set_rules('tglreg','Tanggal','required');
